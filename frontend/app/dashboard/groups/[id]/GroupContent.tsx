          ...
          <div className="xl:col-span-3 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="text-sm font-medium text-gray-600 mb-1">Invite Members</h3>
                  <p className="text-xs text-gray-500">Share the code or send an email invitation</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between mb-4 p-4 bg-gray-50 rounded-lg">
                ...
                <button
                  ...
                  className="p-2 hover:bg-gray-200 rounded-lg transition relative group"
              ...
              {showInviteForm ? (
                <form onSubmit={handleInviteByEmail} className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 bg-indigo-600 text-white py-2 rounded-lg font-medium hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-200 transition disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-indigo-50 text-indigo-700 rounded-lg font-medium hover:bg-indigo-100 transition"
                >
